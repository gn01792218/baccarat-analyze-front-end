<template>
  <section :id="`${RoadDomName.M_BIGROAD}`" class="bigRoad flex w-full h-full absolute top-0 left-0 bg-white">
    <div class="bigRoad-column border-[1px] border-slate-500" :id="`${RoadDomName.M_BIGROAD}-column-${index}`"
